...
.filters-toggle { margin-bottom: var(--space-16); }
.filters-toggle-btn { display: flex; align-items: center; gap: 8px; padding: var(--space-8) var(--space-16); font-size: var(--font-size-sm); border: none; background: none; color: var(--color-primary, #007bff); cursor: pointer; transition: color 0.2s ease; }
.filters-toggle-btn:hover { color: var(--color-primary-dark, #0056b3); }
