  ...
  <div class="dashboard">
    ...
    <div class="container">
      ...
      <section class="dashboard-section">
        ...
        <!-- Carousel Navigation - Upcoming Events -->
        <div class="carousel-navigation">
          <button @click="prevUpcoming" class="carousel-button" :disabled="upcomingCarouselIndex === 0">
            ‹
          </button>
          <button @click="nextUpcoming" class="carousel-button" :disabled="upcomingCarouselIndex >= upcomingEvents.length - 3">
            ›
          </button>
        </div>
      </section>
      ...
      <section class="dashboard-section">
        ...
        <!-- Carousel Navigation - Saved Events -->
        <div class="carousel-navigation">
          <button @click="prevSaved" class="carousel-button" :disabled="savedCarouselIndex === 0">
            ‹
          </button>
          <button @click="nextSaved" class="carousel-button" :disabled="savedCarouselIndex >= savedEvents.length - 3">
            ›
          </button>
        </div>
      </section>
