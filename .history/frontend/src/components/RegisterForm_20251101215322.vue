...
const isFormValid = computed(() => {
  return (
    ...
    role.value !== '' &&
    (role.value !== 'club' || (clubDescription.value.trim() !== '' && clubCategoryId.value !== ''))
  );
});
onMounted(async () => {
  try {
...
<template>
  <div class="register-form">
    ...
    <form @submit.prevent="handleRegister" class="form">
      <!-- Club fields -->
      <div v-if="role === 'club'" class="form-notice" style="margin-bottom: 16px;">
        <p class="notice-text">Provide your club details below.</p>
      </div>

      <div v-if="role === 'club'" class="form-group">
      ...
      <div v-if="role === 'club'" class="form-group">
        ...
        <input id="clubimg" type="file" accept="image/*" class="form-control" @change="onImageChange" />
