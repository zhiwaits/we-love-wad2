...
export default {
    ...
    methods: {
        ...
        getVisibleTagsCount(tags) {
            ...
            // Container constraints - stricter estimate for max 2 rows
            const containerWidth = 280; // More conservative estimate for event card content area
            ...
            for (let i = 0; i < tags.length; i++) {
                ...
                const tagWidth = 16 + (tags[i].length * 7.2) + 8; // Stricter character width estimate
